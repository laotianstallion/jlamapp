	...
	<nav class="navbar navbar-default visible-xs visible-sm mobile-nav navbar-fixed-top" role="navigation">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				<li<?php if ($title == 'celebrity') : ?> class="active"<?php endif; ?>><a href="<?php echo base_url(); ?>">celebrity</a></li>
				...
				<li<?php if ($title == 'lifestyle') : ?> class="active"<?php endif; ?>><a href="<?php echo base_url(); ?>lifesryle">lifestyle</a></li>
			</ul>
			<ul class="nav navbar-nav">
